...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalProject_eGasSheba.Model.accounts.Head", b =>
                {
                    ...
                    b.Property<int>("GroupTypegroupId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinalProject_eGasSheba.Model.marketing.employee", b =>
                {
                    ...
                    b.Property<int>("empDepartmentempDepID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("empDepartmentempDepID");
            ...
            modelBuilder.Entity("FinalProject_eGasSheba.Model.product.product", b =>
                {
                    ...
                    b.HasIndex("DeptdepID");

                    b.HasIndex("DistributorID");

                    b.HasIndex("TypetID");

                    b.HasIndex("WeightwID");
            ...
            modelBuilder.Entity("FinalProject_eGasSheba.Model.sales.InvoiceDetailsProduct", b =>
                {
                    ...
                    b.ToTable("InvoiceDetailsProduct");
                });
            ...
            modelBuilder.Entity("FinalProject_eGasSheba.Model.training.courseSaleDetail", b =>
                {
                    ...
                    b.Property<int>("courscoureID")
                        .HasColumnType("int");

                    b.Property<int>("courseSaleMasterid")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("courscoureID");

                    b.HasIndex("courseSaleMasterid");
            ...
            modelBuilder.Entity("FinalProject_eGasSheba.Model.accounts.Head", b =>
                {
                    b.HasOne("FinalProject_eGasSheba.Model.accounts.GroupType", "GroupType")
                        .WithMany("Heads")
                        .HasForeignKey("GroupTypegroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("FinalProject_eGasSheba.Model.marketing.employee", b =>
                {
                    ...
                    b.HasOne("FinalProject_eGasSheba.Model.marketing.empDepartment", "empDepartment")
                        .WithMany("employees")
                        .HasForeignKey("empDepartmentempDepID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("FinalProject_eGasSheba.Model.puechase.purchaseDetail", b =>
                {
                    b.HasOne("FinalProject_eGasSheba.Model.product.product", "product")
            ...
            modelBuilder.Entity("FinalProject_eGasSheba.Model.services.Appointment", b =>
                {
                    b.HasOne("FinalProject_eGasSheba.Model.child.Area", null)
            ...
            modelBuilder.Entity("FinalProject_eGasSheba.Model.services.AppointmentApproval", b =>
                {
                    ...
                    b.HasOne("FinalProject_eGasSheba.Model.product.product", null)
                        .WithMany("appointmentApproveds")
                        .HasForeignKey("productproID")
                        .OnDelete(DeleteBehavior.Restrict);
